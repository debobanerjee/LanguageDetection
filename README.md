...
```
#### Or edit the `getting_started_model_inference_v1.py` file and run it as shown below
```
python getting_started_model_inference_v1.py
```
...
```
#### Or edit the `getting_started_model_inference_v2.py` file and run it as shown below
```
python getting_started_model_inference_v2.py
```
